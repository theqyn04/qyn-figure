...
namespace qyn_figure.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Details(int Id)
        {
            ...
            if (productDetails == null) return RedirectToAction("Index"); // Hoặc Redirect

            //Chọn 4 sản phẩm liên quan đến sản phẩm này để đề xuất cho user
            var relatedProducts = await _context.Products
                .Where(c => c.CategoryId == productDetails.CategoryId && c.Id != Id)
                .OrderByDescending(c => c.Id)
                .Take(4)
                .ToListAsync();
            ViewBag.RelatedBooks = relatedProducts; // Truyền danh sách sản phẩm liên quan sang View
            ...
            return View(viewModel); // ✅ Truyền Model sang View
        }
